...
from database import get_db, User, redis_client
...
async def get_products():
    """Fetches products. Checks Redis Cache first, otherwise loads from 'Database'."""
    ...
    products_data = [
        {"id": 1, "name": "Premium Silk Suit", "price_bdt": 12000},
        {"id": 2, "name": "Embroidered Chiffon", "price_bdt": 8500}
    ]
